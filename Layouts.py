...
class Layout:
    def __init__(self):
        ...
        self.cursorEdit1 = ((self.edit1[x] - 10, self.edit1[y]+ 25 * 1), (self.edit1[x] - 10, self.edit1[y] + 30 * 2))
        self.cursorEdit2 = ((self.edit2[x] - 10, self.edit2[y] + 25 * 1), (self.edit2[x] - 10, self.edit2[y] + 30 * 2))